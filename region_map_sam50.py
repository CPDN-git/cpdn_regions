...
ddir='data/'
region_files=['sam50_region.nc']
region_cols=['LemonChiffon']
...
def map_plot():
    ...
    fig = plt.figure()
    m = Basemap(llcrnrlon=-130.5,llcrnrlat=-5,urcrnrlon=-25.566,urcrnrlat=-50,\
...
#    m = Basemap(projection='ortho',lat_0=35,lon_0=-100,resolution='c')
    ...
    fig.savefig("region_plot_sam50.png")
