...
ddir='data/'
region_files=['cam25_region.nc']
region_cols=['DeepSkyBlue']
...
def map_plot():
    ...
    fig = plt.figure()
    m = Basemap(llcrnrlon=-130.5,llcrnrlat=-20,urcrnrlon=-25.566,urcrnrlat=30,\
...
#    m = Basemap(projection='ortho',lat_0=35,lon_0=-100,resolution='c')
    ...
    fig.savefig("region_plot_cam25.png")
