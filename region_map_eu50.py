...
ddir='data/'
region_files=['eu50r_region.nc']
region_cols=['RoyalBlue']
...
def map_plot():
    ...
    fig = plt.figure()
    m = Basemap(llcrnrlon=-27.5,llcrnrlat=2.,urcrnrlon=118.566,urcrnrlat=70.352,\
...
#    m = Basemap(projection='ortho',lat_0=35,lon_0=-100,resolution='c')
    ...
    fig.savefig("region_plot_eu50.png")
